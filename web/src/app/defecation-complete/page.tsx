...
export default function DefecationCompletePage() {
  ...
  return (
    <div className="min-h-screen text-white relative flex items-center justify-center" style={{background: 'linear-gradient(180deg, #1B3275 0%, #17171C 75%)'}}>
        <button 
          onClick={handleClose} 
      ...
      <div className="flex flex-col items-center justify-center px-8 py-16 relative">
        ...
        <div className="relative mb-8">
          <div className="w-20 h-20 rounded-3xl flex items-center justify-center shadow-2xl flex-shrink-0" style={{aspectRatio: '1/1'}}>
            <Image
              src={CheckPng}
              alt="체크 아이콘"
              width={80}
